...
const Hero = () => {
  return (
    <HeroMotionDiv className=" md:mt-3 w-full">
      <h1 className="justify-between flex items-center text-wine-400 text-left  uppercase w-full text-[1.3rem] md:text-[2.5rem] xl:text-[3rem] xxl:text-[4rem] tracking-normal py-10 font-[800]">
