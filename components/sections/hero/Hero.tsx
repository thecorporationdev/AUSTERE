...
const Hero = () => {
  return (
    <HeroMotionDiv className="md:px-12 md:mt-3 w-full">
      <h1 className="justify-between flex items-center text-wine-400 uppercase w-full text-[1rem] md:text-[2.5rem] xl:text-[2rem] xxl:text-[4.5rem] tracking-wide font-[800]">
