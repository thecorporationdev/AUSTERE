        ...
        <div className="lg:w-1/2 flex justify-end ">
          <Reveal>
            <div className=" text-base flex flex-col gap-y-6 md:text-[17px] font-[400] text-black leading-[24px] lg:leading-[30px] tracking-wide">
              ...
              <p>
                This site was created not only to showcase our achievements and
                capabilities but also to reveal our true selves and what
                inspires us. Please take a moment to scroll down and explore the
                other pages to gain a complete understanding of who we are.{" "}
              </p>
