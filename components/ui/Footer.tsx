...
const Footer = (props: Props) => {
  return (
    <footer className="pt-20 pb-33  h-screen mt-4">
      <div className="w-full">
        <div className="w-full flex items-center justify-center py-24">
          <div className="border-b-2 font-extrabold border-black py-1 text-4xl md:text-6xl  tracking-normal px-4 uppercase">
            Let&apos;s go to work
          </div>
        </div>
