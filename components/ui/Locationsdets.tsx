      ...
      <div className=" w-full md:justify-start flex">
        <div className="border-black border-t-2 md:w-[85%] max-md:mt-4">
          <div className="flex  justify-between md:justify-start">
            <div className="md:w-3/4 flex bg-red-500 flex-col md:flex-row justify-between mt-2">
      ...
      <div className=" w-full flex md:justify-end">
        <div className="border-black border-t-4 md:w-[85%] max-md:mt-4">
          <div className="flex md:justify-end">
            <div className="md:w-3/4 flex-col-reverse bg-purple-600 md:flex-row  justify-between mt-2 flex">
              <p className="md:w-4/12 text-[12px]  font-[400] leading-none mt-3 ">
                515 maitama haruna street jabi park abuja nigeria
              </p>
              <h1 className="font-[500] text-4xl">LA</h1>
