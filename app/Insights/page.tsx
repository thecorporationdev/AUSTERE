        ...
        <div className="w-full justify-start py-10 mt-10">
          <div className="lg:w-1/2 font-bold ">
            <p className="text-xs md:text-sm leading-[20px] lg:leading-[30px]">
              ...
              temporibus aliquid dignissimos adipisci autem consectetur
              voluptates odio molestiae cupiditate, doloremque recusandae
              reprehenderit quo minus quibusdam deserunt quam nihil deleniti
              illo!
            </p>
          </div>
        </div>
